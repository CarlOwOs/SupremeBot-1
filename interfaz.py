...
def cargar():
    ...
    Compra = bot.Compra(datos[0],datos[1],datos[2],datos[3],datos[4],
                        ...
                        datos[10],datos[11],datos[12],datos[13].rstrip())
    bot.dinerito(Compra)

def comprar():
    Compra = bot.Compra(txt_prod.get(), txt_talla.get(), txt_color.get(),
                        box_type.get(), txt_email.get(),
...
lbl_color.grid(column=0, row=2)
txt_color = Entry(window,width=10)
txt_color.grid(column=1, row=2)

lbl_type = Label(window, text="Categoría:")
lbl_type.grid(column=0, row=3)
box_type = Combobox(window)
box_type['values']= ("jackets", "jhirts", "tops_sweaters", "sweatshirts", "pants",
                         "t-shirts", "hats", "bags", "accesories", "shoes", "skate")
box_type.grid(column=1, row=3)

lbl_email = Label(window, text="e-mail:")
lbl_email.grid(column=0, row=4)
txt_email = Entry(window,width=40)
txt_email.grid(column=1, row=4)

lbl_web_name = Label(window, text="Página:")
lbl_web_name.grid(column=0, row=5)
box_web_name = Combobox(window)
box_web_name['values']= ("Supreme", "Amazon", "Adidas")
box_web_name.grid(column=1, row=5)

lbl_cardn = Label(window, text="Tarjeta de crédito:")
lbl_cardn.grid(column=0, row=6)
txt_cardn = Entry(window,width=40)
txt_cardn.grid(column=1, row=6)

lbl_codigo = Label(window, text="CVV:")
lbl_codigo.grid(column=0, row=7)
txt_codigo = Entry(window,width=10)
txt_codigo.grid(column=1, row=7)

lbl_venc = Label(window, text="Fecha vencimiento:")
lbl_venc.grid(column=0, row=8)
txt_venc = Entry(window,width=10)
txt_venc.grid(column=1, row=8)

lbl_nom = Label(window, text="Nombre completo:")
lbl_nom.grid(column=0, row=9)
txt_nom = Entry(window,width=40)
txt_nom.grid(column=1, row=9)

lbl_dir = Label(window, text="Dirección:")
lbl_dir.grid(column=0, row=10)
txt_dir = Entry(window,width=40)
txt_dir.grid(column=1, row=10)

lbl_cp = Label(window, text="C.P.:")
lbl_cp.grid(column=0, row=11)
txt_cp = Entry(window,width=40)
txt_cp.grid(column=1, row=11)

lbl_ciudad = Label(window, text="Ciudad:")
lbl_ciudad.grid(column=0, row=12)
txt_ciudad = Entry(window,width=40)
txt_ciudad.grid(column=1, row=12)

lbl_tel = Label(window, text="Teléfono:")
lbl_tel.grid(column=0, row=13)
txt_tel = Entry(window,width=40)
txt_tel.grid(column=1, row=13)

btn_carga = Button(window, text="Cargar y comprar", command=cargar)
btn_carga.grid(column=0, row=14)
